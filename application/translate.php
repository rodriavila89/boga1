...
class Translate {
  ...
  public function __construct($options = array()) {
    ...
    if (array_key_exists('ruta_modal', $options)) {
        $this->_ruta_modal = $options['ruta_modal'].'/'.self::LANGUAGE_PATH;    
    }
  ...
  public function getList() {
   ...
   if($this->_ruta_modal!=''){
        $ruta = $this->_ruta_modal;
   }else{
        $ruta = self::LANGUAGE_PATH;
   }
   if ($handle = opendir(realpath($ruta))) {
