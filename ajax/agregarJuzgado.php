...
echo '<table  class="table"><tr><td colspan=2>';
    ...
    echo '<label class="control-label" for="nombre_modal">'.ucfirst($translate->_('_nombre')).'</label>';
    echo '<input type="text" class="form-control input-lg" id="nombre_modal" name="nombre_modal">';
    echo '</div>';
